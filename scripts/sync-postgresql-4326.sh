...
# =============================================================================
# TKGM PostgreSQL Senkronizasyonu (EPSG:4326) - Optimize Edilmiş Script
# Kaynak PostgreSQL'den Hedef PostgreSQL'e tk_parsel_4326 tablosu aktarımı
# Geometriler orijinal WGS84 (EPSG:4326) koordinat sisteminde saklanır
# =============================================================================
...
load_config() {
    ...
    LOG_FILE="${log_dir:-./}/cron_postgresql_4326.log"
    ...
    POSTGRES_TARGET_TABLE="${POSTGRES_TARGET_TABLE:-tk_parsel_4326}"
...
get_sql_query() {
    cat <<'EOF'
SELECT * FROM public.tk_parsel_4326 p
EOF
}
...
main() {
    load_config
    log "=== TKGM PostgreSQL Sync (EPSG:4326) Started ==="
